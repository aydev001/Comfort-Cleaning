            ...
            <Container type={"main"}>
                <div className='flex justify-between gap-[20px] flex-col md:flex-row'>
                    <div className='flex-[1.3] lg:flex-1 flex flex-col justify-center gap-[10px]'>
                        ...
                        <h2 data-aos="fade-up" data-aos-delay="200" className='text-[50px] drop-shadow-md md:text-[60px] lg:text-[70px] font-bold text-primary-600 leading-[50px] md:leading-[60px] lg:leading-[75px]'>
                            {t("home_main-title")}
                        </h2>
